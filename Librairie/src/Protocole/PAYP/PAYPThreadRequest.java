...
public class PAYPThreadRequest extends ServeurRequete {
    ...
    private static SSLSocket createSSLSocket(String keyStoreFilename, String password, String servername, int port) throws IOException, KeyManagementException, NoSuchAlgorithmException, UnrecoverableKeyException, KeyStoreException, CertificateException {
