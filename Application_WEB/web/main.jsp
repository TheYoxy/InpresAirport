            ...
            try {
                while (rs.next()) {
                    if (rs.getInt("PlacesDisponible") > 0) {
                        ...
                        out.println("<form method=\"post\" action=\"Servlet/CaddieServlet\">");
                        out.println("<input id=\"numVol\" type=\"hidden\" name=\"numVol\" value=\""+ rs.getString("NumeroVol")+"\">\n");
                        out.println("<input id=\"nbrPlaces\" type=\"hidden\" name=\"nbrPlaces\" value=\"add\">\n");
                        out.println("<input id=\"type\" type=\"hidden\" name=\"type\" value=\"add\">\n");
                        out.println("<input class=\"full-width\" type=\"submit\" value=\"Acheter!\">");
