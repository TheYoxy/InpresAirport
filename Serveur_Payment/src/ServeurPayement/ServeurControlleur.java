...
public class ServeurControlleur implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        ts = new ThreadServeur(Integer.valueOf(PropertiesReader.getProperties("PORT_PAYEMENT")),
                Integer.valueOf(PropertiesReader.getProperties("NB_THREADS")), PAYPThreadRequest.class);
